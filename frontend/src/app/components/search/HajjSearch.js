...
import { MapPin, Calendar, User, Search, X, Plus, Minus, Landmark, Moon } from "lucide-react";
...
export default function HajjSearch({ onSearch }) {
  ...
  const [dateDisplay, setDateDisplay] = useState("Mon, May 25 - Fri, Jun 12 (Hajj Season)");
    ...
    <div className="w-full bg-white space-y-4">
      ...
      <form onSubmit={handleSubmit} className="w-full">
        <div className="flex flex-col lg:flex-row items-center gap-2.5 w-full">
          ...
          <button
            type="submit"
            aria-label="Search Hajj packages"
